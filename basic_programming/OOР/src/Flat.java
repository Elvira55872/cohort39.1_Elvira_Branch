...
//                System.out.printf("\n %s был выселен из квартиры %d ", name, numberOfFlat);
    ...
    public boolean equals(Object object) {
        ...
        // в одинаковых квартирах будут равны: номер квартиры, площадь и кол-во комнат, поэтому сравниваем только их
        //if (this.numberOfFlat == obj.numberOfFlat) return true;
        boolean isNumberOfFlatSame = this.numberOfFlat == obj.numberOfFlat;
        boolean isSquareSame = this.square == obj.square;
        boolean isAmountOfRoomsSame = this.amountOfRooms == obj.amountOfRooms;
        return isNumberOfFlatSame && isSquareSame && isAmountOfRoomsSame;
    }
